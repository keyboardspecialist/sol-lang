...
| [ ] | P1a.3b2 | Complete structured executable-core CFG lowering | Add owned temporary cleanup and lower multi-operand records/tuples/enums, checked refined construction, recursive matches/guards, propagation, projected places, handlers, capability/method/callback calls, contracts/snapshots, and every E6 callable |
