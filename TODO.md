...
| [ ] | P2.3b | Complete concrete executable CFG materialization | Add explicit handler source/provider bindings; convert concrete overlays into the executable SSA/place/instruction vocabulary; close any specialization/callable discovery fixed point; and independently revalidate concrete SSA dominance, affine ownership, cleanup, contracts/refinements, and handler balance without relying on provenance-only symbolic topology fields |
