...
static const SolKeyword SOL_KEYWORDS[] = {
    ...
    {"pure", SOL_TOKEN_PURE},
    {"require", SOL_TOKEN_REQUIRE},
    {"panic", SOL_TOKEN_PANIC},
    {"unreachable", SOL_TOKEN_UNREACHABLE},
    {"because", SOL_TOKEN_BECAUSE},
    {"let", SOL_TOKEN_LET},
    {"var", SOL_TOKEN_VAR},
...
const char *sol_token_kind_name(SolTokenKind kind) {
    static const char *names[] = {
        ...
        "trait", "implementation", "for", "function", "borrow", "inout", "test", "effects", "requires", "ensures", "pure", "require", "panic", "unreachable", "because", "let", "var", "return", "region", "modify",
