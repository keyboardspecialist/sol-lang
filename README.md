...
This bounded package subset has no manifest, external dependencies, package aliases, re-exports, relative imports, grouped imports, wildcard imports, import aliases, module-to-filesystem-path requirement, imported extension-method search, or stable cross-build semantic IDs. Directory traversal does not follow nested symbolic links. Multiple files may contribute to one module, and private declarations are module-visible in this subset; the target language's distinct private/module/package visibility levels remain future work.
